...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'save_holiday' && $is_hr) {
        ...
        header("Location: home.php?month=$redirectM&year=$redirectY");
        exit;
    }
    ...
    <nav class="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center">
            ...
            <div class="flex items-center gap-8">
                <a href="home.php" class="text-xl font-extrabold tracking-tight flex items-center gap-2 text-gray-900">
