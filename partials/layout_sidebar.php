...
<aside class="sidebar">
    ...
    <div class="nav-group">
        ...
        <a href="<?php echo baseUrl('home'); ?>"
            class="nav-item <?php echo (strpos($uri, '/home') !== false) ? 'active' : ''; ?>" title="Home Feed">
            <div class="nav-ico"><i class="fa-solid fa-house"></i></div>
            <span>Home Feed</span>
        </a>

        <?php if ($is_hr || $is_ceo): ?>
            <a href="<?php echo baseUrl(getDashboardUrl()); ?>"
                class="nav-item <?php echo (strpos($uri, '/dashboard') !== false || strpos($uri, '/ceodashboard') !== false) ? 'active' : ''; ?>"
                title="Dashboard">
    ...
    <div class="nav-group">
        ...
        <a href="<?php echo baseUrl('timecard'); ?>"
            class="nav-item <?php echo (strpos($uri, '/timecard') !== false) ? 'active' : ''; ?>" title="My Timecard">
            <div class="nav-ico"><i class="fa-solid fa-clock-rotate-left"></i></div>
            <span>Timecard</span>
        </a>
        <a href="<?php echo baseUrl('schedule'); ?>"
            class="nav-item <?php echo (strpos($uri, '/schedule') !== false && strpos($uri, 'dept_id') === false) ? 'active' : ''; ?>"
            title="My Schedule">
        ...
        <a href="<?php echo baseUrl('overtime'); ?>"
            class="nav-item <?php echo (strpos($uri, '/overtime') !== false) ? 'active' : ''; ?>"
            title="Overtime Request">
            <div class="nav-ico"><i class="fa-solid fa-business-time"></i></div>
            <span>Overtime Request</span>
        </a>
        <a href="<?php echo baseUrl('payslip'); ?>"
            class="nav-item <?php echo (strpos($uri, '/payslip') !== false) ? 'active' : ''; ?>" title="My Payslips">
            <div class="nav-ico"><i class="fa-solid fa-file-invoice-dollar"></i></div>
            <span>Payslips</span>
        </a>
        <a href="<?php echo baseUrl('loan'); ?>"
            class="nav-item <?php echo (strpos($uri, '/loan') !== false) ? 'active' : ''; ?>" title="My Loans">
    ...
    <?php if ($is_hr || $is_ceo): ?>
        <div class="nav-group">
            ...
            <a href="<?php echo baseUrl('employee'); ?>"
                class="nav-item <?php echo (strpos($uri, '/employee') !== false) ? 'active' : ''; ?>"
                title="Employee Directory">
                <div class="nav-ico"><i class="fa-solid fa-users"></i></div>
                <span>Employee Directory</span>
            </a>

            <div class="nav-item has-sub" onclick="this.nextElementSibling.classList.toggle('open')"
            ...
            <div class="nav-sub">
                <a href="<?php echo baseUrl('cutoff-setup'); ?>"
                    class="nav-sub-item <?php echo (strpos($uri, '/cutoff-setup') !== false) ? 'active' : ''; ?>">Cutoff
                    Setup</a>
                <a href="<?php echo baseUrl('payroll-calculator'); ?>"
                    class="nav-sub-item <?php echo (strpos($uri, '/payroll-calculator') !== false) ? 'active' : ''; ?>">Payroll
                    Calc</a>
                <a href="<?php echo baseUrl('allowances'); ?>"
                    class="nav-sub-item <?php echo (strpos($uri, '/allowances') !== false) ? 'active' : ''; ?>">Allowances</a>
                <a href="<?php echo baseUrl('timecard?action=audit'); ?>"
                    class="nav-sub-item <?php echo (strpos($uri, 'action=audit') !== false) ? 'active' : ''; ?>">Biometric
                    Audit</a>
            </div>
        </div>
    <?php endif; ?>
